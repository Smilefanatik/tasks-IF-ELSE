...
function f3() {
  let num1 = input31.value;
  let num2 = input32.value;
  if (num1 > num2) {
    out3.innerHTML = num1;
  } else {
    out3.innerHTML = num2;
...
function f7() {
  let num71 = input71.value;
  let num72 = input72.value;
  let mat = Math.pow(num71, num72);
  out7.innerHTML = mat;
}
...
function f9() {
  let num9 = input9.value;
  if (num9 > 1 && num9 <= 32) {
    out9.innerHTML = 1;
  } else if (num9 > 32 && num9 <= 43) {
    out9.innerHTML = 2;
  } else if (num9 > 43 && num9 <= 64) {
    out9.innerHTML = 3;
  } else {
    out9.innerHTML = 0;
  }
...
function f14() {
  let val14 = select143.value;
  if (val14 == "+") {
    out14.innerHTML = i141.valueAsNumber + i142.valueAsNumber;
  } else if (val14 == "-") {
    out14.innerHTML = i141.valueAsNumber - i142.valueAsNumber;
  } else if (val14 == "*") {
    out14.innerHTML = i141.valueAsNumber * i142.valueAsNumber;
...
function f15() {
  let val151 = select151.value;
  let val152 = select152.value;
  let val153 = select153.value;

  if (val153 == "&&" && val151 == '1' && val152 == '1') {  
    out15.innerHTML = 1;
  } else if (val153 == "&&" && val151 == '0' && val152 == '0') {
    out15.innerHTML = 0;
  } else {
    out15.innerHTML = 1;
  } 
